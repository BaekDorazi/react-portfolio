            ...
            <div className="contents-text">
              <div className="text-a">
                <span>
                  ...
                  <br />
                  <br />
                  학창시절에 사회 현장에서 맺었던 작은 인연들 즉, 다방면의
                  디자인 작업들과 촬영, 기획, 편집 등은 앞으로 해 나가야 할
                  작업들의 좋은 기반이 되었고 그만큼 실수도 줄일 수 있는 한번 더
                  생각하는 신중함을 배우게 되었습니다.
                  <br />
                  <br />
              ...
              <div className="text-b">
                <span>
                  ...
                  대학로나 동대문에 나가 문화와 사회의 흐름을 읽어내고, 더
                  나아가 좋은 아이디어가 발견되면 항상 메모하는 습관, 스크랩하는
                  습관이 있으며 사물을 똑바로 바라볼 수 있는 냉철함을 기르기
                  위해 노력하고 있습니다.
                </span>
              </div>
            </div>
